            ...
            <div className='container'>
                <div className='flex justify-between'>
                    <div className='pt-12 pb-12'>
                        ...
                        <p className='font-inter font-normal leading-6 text-base text-[#9CA3AF] w-67.25'>
                    ...
                    <div className='pt-12'>
                        ...
                        <ul className=''>
                            <li className=' text-[#9CA3AF]'><a href="#"> Home</a></li>
                            <li className=' text-[#9CA3AF]'><a href="#"> Categories</a></li>
                            <li className=' text-[#9CA3AF]'><a href="#"> Deals</a></li>
                            <li className=' text-[#9CA3AF]'><a href="#"> About Us</a></li>
                        </ul>
                    </div>
                    <div className='pt-12'>
                        <h4 className='same'>
                        ...
                        <ul>
                            <li className=' text-[#9CA3AF]'><a href=""> Contact Us</a></li>
                            <li className=' text-[#9CA3AF]'><a href=""> Shipping Info</a></li>
                            <li className=' text-[#9CA3AF]'><a href=""> Returns</a></li>
                            <li className=' text-[#9CA3AF]'><a href=""> FAQ</a></li>
                        </ul>
                    </div>
                    <div className='pt-12'>
                        <h4 className='same'>
                        ...
                        <h5 className=' text-[#9CA3AF] mb-4'> Subscribe for updates and deals</h5>
                        <input className=' text-[#ADAEBC] bg-[#E5E7EB] w-70 rounded-tl-lg rounded-bl-lg placeholder:text-[#ADAEBC] placeholder:font-inter pl-4 h-10 border text-base font-normal border-none outline-none' type="text" placeholder='Your Email' />
                        <button className=' text-[#FFFFFF] bg-[#3B82F6] font-inter text-base pt-2.5 pl-4 pb-1.5 pr-2.5 rounded-tr-lg rounded-br-lg h-10.25'> Subscribe</button>
                    </div>
                    
                </div>
                <div className='border-[#1F2937] border-t '></div>
                <h5 className='font-inter text-base font-normal leading-6 text-[#9CA3AF] text-center pt-10 pb-12'> © 2024 ShopHub. All rights reserved.</h5>
            </div>
        </footer>
    )
}
